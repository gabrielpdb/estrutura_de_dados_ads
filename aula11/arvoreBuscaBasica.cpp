...
main(){
 ...
 do{
  ...
  printf("selecione: \n");  
  scanf("%d",&op);
  switch(op){//neste programa estamos inserindo um conjunto fixo de dados para teste
  	case 1: 
  	  for(i=0;i<20;i++){
  	  	numero = dados[i];
...
//Retorno o endereço da posição de memória alocada
...
//ATIVIDADE - FAZER A IMPLEMENTAÇÃO DAS FUNÇÕES A SEGUIR

//Varre e mostra todos os elementos da árvore
//implementa o percurso prefixo: Raiz - SAE - SAD
void prefixo(nodo *a){
//aqui você deve implementar a função prefixo
...
void posfixo(nodo *a){
//aqui você deve implementar a função posfixo
...
void decrescente(nodo *a){
//aqui você deve implementar a função decrescente	
